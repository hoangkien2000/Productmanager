...
namespace WebSiteBanHang.Controllers
{
    public class TimKiemController : Controller
    {
        ...
        public ActionResult KQTimKiemAdmin(string sTuKhoa, int? page)
        {
            if (Request.HttpMethod != "GET")
            {
                page = 1;
        ...
        [HttpPost]
        public ActionResult AdminLayTuKhoaTimKiem(string sTuKhoa)
        {
            // Gọi về hàm get tìm kiếm
            return RedirectToAction("KQTimKiemAdmin", new { @sTuKhoa = sTuKhoa });
        }
