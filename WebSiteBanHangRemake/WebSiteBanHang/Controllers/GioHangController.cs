    ...
    public class GioHangController : Controller
    {
        ...
        public ActionResult DatHang(KhachHang kh)
        {
            ...
            foreach (var item in lstGioHang)
            {
                ...
                chitiet += "Tên sản phẩm : " + item.TenSP.ToString();
                chitiet += " - Số lượng : " + item.SoLuong.ToString();
                chitiet += " - Giá : " + item.DonGia.ToString();
                chitiet += " - Thành tiền : " + (item.SoLuong * item.DonGia).ToString();
                chitiet += "\n";
                db.ChiTietDonDatHangs.Add(ctdh);
            }
            db.SaveChanges();
            string _Body = chitiet;
            string _Subject = "Xác nhận đơn hàng";
            var mail = ddh.Email;
            SendMail(mail, _Subject, _Body);
        ...
        public void SendMail(string _To, String _Subject, string _Body)
        {
            DonDatHang ddh = new DonDatHang();
            ddh.Email = _To;
            //TODO: Mail gửi, bật cái này lên https://myaccount.google.com/lesssecureapps 
            string emailName = "laihuyha1111@gmail.com";
            string pass = "Ha11122000";

            using (MailMessage m = new MailMessage(emailName, _To))
            {
                m.Subject = _Subject;
                m.Body = _Body;
                ...
                using (SmtpClient smtp = new SmtpClient())
                {
                    ...
                    NetworkCredential credential = new NetworkCredential(emailName, pass);
